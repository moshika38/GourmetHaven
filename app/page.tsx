        ...
        <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
          ...
          <div className="container relative z-10 px-4 text-center animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
              Experience the authentic flavors of locally sourced ingredients, handcrafted with love and tradition. Best pizza and coffee in town.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link href="/menu">
                <Button size="lg" className="rounded-full px-8 text-lg font-semibold shadow-xl shadow-primary/20">
                  Order Now <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
              </Link>
              <Link href="/about">
                <Button variant="outline" size="lg" className="rounded-full px-8 text-lg backdrop-blur-sm bg-white/5 border-white/20 hover:bg-white/10">
                  View Menu
                </Button>
              </Link>
            </div>
          ...
          <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div className="flex flex-col items-center gap-2">
             ...
             <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">Voted #1 in the city</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 relative overflow-hidden">
           <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold mb-4">Our Favorites</h2>
              <p className="text-muted-foreground max-w-xl mx-auto">
                Handpicked by our chefs, these are the dishes that keep our customers coming back for more.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="group rounded-2xl bg-card border border-white/5 overflow-hidden hover:border-primary/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10">
                ...
                <div className="p-6">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-xl font-bold">Signature Truffle Pizza</h3>
                  </div>
                  <p className="text-muted-foreground text-sm mb-4 line-clamp-2">
                    Fresh mozzarella, truffle oil, basil, and prosciutto on a sourdough crust.
                  </p>
              ...
              <div className="group rounded-2xl bg-card border border-white/5 overflow-hidden hover:border-primary/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10">
                ...
                <div className="p-6">
                   <div className="flex justify-between items-start mb-2">
                    <h3 className="text-xl font-bold">Morning Roast Cappuccino</h3>
                  </div>
                  <p className="text-muted-foreground text-sm mb-4 line-clamp-2">
                    Premium arabica beans matched with creamy steamed milk and latte art.
                  </p>
                  <Button className="w-full" size="sm">Add to Cart</Button>
                </div>
              </div>
               ...
               <div className="group rounded-2xl bg-card border border-white/5 overflow-hidden hover:border-primary/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10">
                ...
                <div className="p-6">
                  ...
                  <p className="text-muted-foreground text-sm mb-4 line-clamp-2">
                    Homemade pasta with rich tomato basil sauce and parmesan cheese.
                  </p>
                  <Button className="w-full" variant="secondary" disabled size="sm">Out of Stock</Button>
                </div>
              </div>
            ...
            <div className="mt-12 text-center">
              <Link href="/menu">
                <Button variant="outline" size="lg" className="px-8">View Full Menu</Button>
              </Link>
            </div>
           </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 text-center shadow-2xl relative overflow-hidden group">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link href="/auth/register">
                   <Button size="lg" className="h-14 px-8 text-lg rounded-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:-translate-y-0.5 transition-all duration-300">
                    Create Account
                  </Button>
                </Link>
                <Link href="/menu">
                  <Button variant="outline" size="lg" className="h-14 px-8 text-lg rounded-full border-white/20 bg-transparent text-white hover:bg-white/10 backdrop-blur-sm transition-all duration-300">
                    Browse Menu
                  </Button>
                </Link>
              </div>
